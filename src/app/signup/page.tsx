...
const signUp = () => {
  return (
    <main className="flex justify-between  mx-32 mt-16 mb-28">
      <section className="flex-col space-y-72 basis-1/2">
        <article>
          <p className="font-bold text-black text-4xl leading-10">
            Sign up & manage Investment, donations & more
          </p>
        ...
        <article className="flex-col space-y-8 px-7 pb-7 pt-9 border border-c2e9ed rounded-xl bg-f4feff">
          <div className="flex justify-between">
            <p className="font-regular text-base leading-5">
              Already signed up with Lending Micra?
            </p>
            <Link
              href="/login"
      ...
      <section className="relative top-0 bg-top-left bg-[url('/images/bgSquare.png'),_url('/images/bgSquare.png')]   bg-[length:length:300px,_300px] bg-[position:left_0px_top_0px,_right_0px_bottom_0px] bg-no-repeat py-8 px-8">
        <article className="border border-black rounded-xl pt-8 pb-12 shadow-3xl  bg-white">
          <div className="ml-8">
            <p className="font-bold text-4xl leading-10">Sign Up</p>
            <p>Sign up with google and facebook or enter your details.</p>
          </div>

          <div className="flex gap-4 mt-7 mb-11 ml-9 mr-10">
            <Link
              href="https://accounts.google.com/v3/signin/identifier?dsh=S100709016%3A1686843989111020&ffgf=1&hl=en_GB&ifkv=Af_xneF38sKeBbyUqn5y2lsQbZDZpa-NeBFNhYikFEsaaiyO8GTj_tzSSQqEsIw-HZZC3-62AUou&flowName=GlifWebSignIn&flowEntry=ServiceLogin"
              className="font-bold text-base leading-5 rounded-full border border-black border-solid px-5 py-1"
            >
            ...
            <Link
              ...
              className="font-bold text-base leading-5 bg-facebookbg text-white rounded-full px-5 py-1 "
            >
              <p className="flex items-center gap-[2px]">
                <BiLogoFacebook className="text-2xl" /> Sign Up with facebook
              </p>
            </Link>
          </div>
